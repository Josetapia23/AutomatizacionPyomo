...
def ejecutar_flujo_completo():
    ...
    2. Procesar ofertas
    3. Leer demanda
    4. Construir y resolver modelo de optimización
    ...
    try:
        ...
        print("\n=== PASO 9: EXPORTAR ASIGNACIONES ===")
        exportar_asignaciones_por_oferta(asignaciones_df, RESULTADO_OFERTAS)
        
        # Paso 11: Crear hoja de demanda faltante
        print("\n=== PASO 10: REGISTRAR DEMANDA FALTANTE ===")
...
def mostrar_menu():
    ...
    print("3. Procesar ofertas")
    print("4. Optimizar asignación de ofertas")
    ...
    return solicitar_input_seguro(
        ...
        tipo=int,
        validacion=lambda x: 0 <= x <= 5,
        mensaje_error="Opción inválida. Ingrese un número entre 0 y 5."
    )
...
def main():
    ...
    while True:
        ...
        if opcion == 0:
            ...
            print("\n=== PROCESAR OFERTAS ===")
            procesar_precio_sicep(DATOS_INICIALES)
            procesar_ofertas(OFERTAS_DIR, DATOS_INICIALES, RESULTADO_OFERTAS)
        elif opcion == 4:
